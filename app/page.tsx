...
const cases = [
  ...
  },
  {
    ...
    title: "RAC 360",
    copy: "Una solución que convierte hallazgos SSOMA en un historial trazable y comparable, preparado para detectar patrones con IA y fortalecer la prevención SST.",
    tags: ["Inspección móvil", "Trazabilidad SST", "Patrones de riesgo", "Base para IA"],
