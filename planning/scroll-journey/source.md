...
- Usar `public/assets/paolo-gonzales.webp` como referencia de identidad.
...
1. “Estoy en mi oficina revisando un proceso que todavía depende de hojas, mensajes y tareas manuales.”
2. “Primero observo cómo trabaja el equipo y encuentro dónde se pierde tiempo, información y trazabilidad.”
3. “Después convierto ese recorrido en una aplicación simple, conectando formularios, reglas y responsables.”
4. “La solución llega al trabajo real: el equipo registra datos desde campo, obra, almacén o celular.”
5. “Las automatizaciones generan alertas, documentos y aprobaciones sin volver a digitar la información.”
6. “Los datos terminan en tableros claros para controlar facturación, riesgos, productividad y próximos pasos.”
7. “Capacito al equipo para que adopte la solución y pueda seguir mejorándola.”
8. “Al final del recorrido, conversemos sobre el proceso que quieres digitalizar.”

## Contenido real que alimenta las escenas

- Hero: digitalización de procesos que consumen tiempo.
- Casos TIMCO, PDK Perú y Parte Diario.
- Aplicaciones empresariales, AppSheet, Apps Script, MySQL, dashboards y automatización.
- Método Entender, Diseñar, Conectar y Evolucionar.
- Capacitación práctica en AppSheet.
- CTA mediante WhatsApp y correo.
...
- El contenido sigue siendo accesible y legible con movimiento reducido.
